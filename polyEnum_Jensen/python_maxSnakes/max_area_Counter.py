class max_area_Counter:
    ...
    def __add__(self, other):
        assert isinstance(other,max_area_Counter)

        if self.max_area > other.max_area:
            return max_area_Counter(self.max_area, self.nb_configs)
        elif self.max_area < other.max_area:
            return max_area_Counter(other.max_area, other.nb_configs)
        else:
            return max_area_Counter(self.max_area, self.nb_configs + other.nb_configs)
