...
def test_signature_class():
    states = [0,3,3,2]
    predecessor_occupation = [True,True,False,True]
    # sig = Signature(states,predecessor_occupation,True,True)
    sig = Signature(states,predecessor_occupation,False,True)
    print(sig)
    print("\nMirror")
    print(sig.mirrored())
